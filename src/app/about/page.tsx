...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    modifiedTime: "2025-01-21T02:20:10+05:30",
    images: [
      {
        url: "/images/about/meeting-2-768x534.jpg.webp",
        width: 768,
        height: 534,
  ...
  twitter: {
    ...
    title,
    description,
    images: ["/images/about/meeting-2-768x534.jpg.webp"],
  },
};
...
const jsonLd = {
  ...
  dateModified: "2025-01-21T02:20:10+05:30",
  isPartOf: { "@id": "https://codezela.com/#website" },
  about: { "@id": "https://codezela.com/#organization" },
  primaryImageOfPage: {
    "@type": "ImageObject",
    url: "https://codezela.com/images/about/meeting-2-768x534.jpg.webp",
    width: 768,
    height: 534,
  },
  inLanguage: "en-GB",
