    ...
    >
      <div className="site-shell">
        ...
        <Carousel
          ...
          className="mt-[35px] md:mt-[45px] [&_.overflow-hidden>div]:gap-[10px]"
        ...
        >
          {services.map((service, index) => {
            ...
            return (
              <article
                key={service.title}
                className="h-[383px] min-w-0 shrink-0 grow-0 basis-full rounded-[8px] border border-[#f0dff2] bg-[#fffdff] px-[30px] pt-[40px] text-center md:h-[377px] md:basis-[calc((100%_-_10px)/2)] md:px-[40px] md:pt-[75px] xl:basis-[calc((100%_-_20px)/3)]"
